(function(){
  ...
  if(dialog){
    ...
    if(typeWrap){
      ...
      if(!document.getElementById('ntAbsenceTypeStyle')){var st=document.createElement('style');st.id='ntAbsenceTypeStyle';st.textContent='.nt-absence-type-grid{display:grid;gap:.55rem}.nt-absence-type{display:flex;align-items:center;gap:.7rem;padding:.7rem .8rem;border:1px solid #dbe4eb;border-radius:12px;background:#fff;cursor:pointer}.nt-absence-type:has(input:checked){border-color:#0ea5e9;background:#f0f9ff;box-shadow:0 0 0 2px rgba(14,165,233,.08)}.nt-absence-type input{width:1.05rem;height:1.05rem}.nt-absence-type span{display:flex;align-items:baseline;gap:.5rem;flex-wrap:wrap}.nt-absence-type strong{font-size:.92rem}.nt-absence-type small{color:#64748b;font-size:.72rem}.nt-absence-reason-summary{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:.7rem;margin:-.25rem 0 1rem}.nt-absence-reason-stat{padding:.7rem .8rem;border:1px solid #dce5ec;border-radius:13px;background:#fff}.nt-absence-reason-stat strong{display:block;font-size:1.25rem;color:#b91c1c}.nt-absence-reason-stat span{font-size:.78rem;font-weight:700;color:#475569}.nt-absence-label-short{display:none}@media(max-width:767px){.nt-absence-reason-summary{grid-template-columns:repeat(3,minmax(0,1fr));gap:.35rem;margin:-.1rem 0 .65rem}.nt-absence-reason-stat{display:block;min-width:0;padding:.45rem .25rem;border-radius:10px;text-align:center}.nt-absence-reason-stat strong{font-size:1.05rem;line-height:1.1;margin-bottom:.18rem}.nt-absence-reason-stat span{display:block;font-size:.66rem;line-height:1.15;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.nt-absence-label-full{display:none}.nt-absence-label-short{display:inline}}';document.head.appendChild(st);}
    }
  }

  var reasonStats=null,summary=document.querySelector('.att-summary');
  if(summary){reasonStats=document.createElement('div');reasonStats.className='nt-absence-reason-summary';reasonStats.innerHTML='<div class="nt-absence-reason-stat"><strong data-count="P">0</strong><span><span class="nt-absence-label-full">Có phép</span><span class="nt-absence-label-short">Có phép</span></span></div><div class="nt-absence-reason-stat"><strong data-count="P_SAU_AN">0</strong><span><span class="nt-absence-label-full">Có phép sau thời gian đăng ký bữa ăn</span><span class="nt-absence-label-short">Sau chốt</span></span></div><div class="nt-absence-reason-stat"><strong data-count="KP">0</strong><span><span class="nt-absence-label-full">Không phép</span><span class="nt-absence-label-short">K. phép</span></span></div>';summary.insertAdjacentElement('afterend',reasonStats);}
