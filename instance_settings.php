...
<div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-4"><div><h2 class="mb-1"><i class="bi bi-sliders"></i> Cấu hình trường</h2><div class="text-muted">Một nơi duy nhất để cấu hình bản CDS khi triển khai sang trường khác.</div></div><div class="d-flex flex-wrap gap-2"><a href="initial_setup.php" class="btn btn-outline-primary"><i class="bi bi-list-check"></i> Khởi tạo dữ liệu</a><a href="admin.php" class="btn btn-outline-secondary">Quay lại quản trị</a></div></div>
<?php show_flash(); ?>
...
<div class="d-flex justify-content-end gap-2 mb-4"><a class="btn btn-outline-secondary" href="admin.php">Hủy</a><button class="btn btn-primary btn-lg px-4"><i class="bi bi-check2-circle"></i> Lưu bộ cấu hình trường</button></div>
</form>
<div class="card mb-5 border border-primary border-opacity-25"><div class="card-body p-4 d-flex flex-wrap justify-content-between align-items-center gap-3"><div><h5 class="section-title mb-1">6. Khởi tạo và nạp dữ liệu</h5><div class="text-muted">Sau khi lưu cấu hình, thực hiện lần lượt: MySQL → năm học → giáo viên → lớp → học sinh → tài khoản và phân quyền.</div><div class="form-text mt-1"><i class="bi bi-shield-check text-success"></i> Trang hướng dẫn chỉ đọc trạng thái, không tự thay đổi dữ liệu đang vận hành.</div></div><a class="btn btn-primary btn-lg" href="initial_setup.php"><i class="bi bi-list-check"></i> Tiếp tục khởi tạo dữ liệu</a></div></div>
</main></body></html>
