...
ob_start(static function (string $html) use ($latestDocumentsJson, $vanbanUrl, $checkUrl, $timetableUrl): string {
    $script = <<<'HTML'
...
(function(){
 ...
 const timetableUrl=__TIMETABLE_URL__;
 ...
 if(quick){
   ...
   const wanted=[attendance,meals,timetable,professional].filter(Boolean);
