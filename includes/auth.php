...
function cds_drive_default_types(): array {return ['documents'=>['label'=>'Văn bản','folder_id'=>'','prefix'=>'Van-ban'],'plans'=>['label'=>'Kế hoạch và báo cáo','folder_id'=>'','prefix'=>'Ke-hoach'],'education_plans'=>['label'=>'Kế hoạch giáo dục','folder_id'=>'','prefix'=>'Ke-hoach-giao-duc'],'learning_resources'=>['label'=>'Học liệu số','folder_id'=>'','prefix'=>'Hoc-lieu'],'exam_bank'=>['label'=>'Kiểm tra và thi','folder_id'=>'','prefix'=>'Kiem-tra-thi'],'photos'=>['label'=>'Ảnh học sinh và CBGV','folder_id'=>'','prefix'=>'Anh-the'],'observations'=>['label'=>'Phiếu dự giờ','folder_id'=>'','prefix'=>'Phieu-du-gio'],'duty_reports'=>['label'=>'Biên bản trực nội trú','folder_id'=>'','prefix'=>'Bien-ban-truc'],'meal_reports'=>['label'=>'Thống kê ăn các lớp','folder_id'=>'','prefix'=>'Thong-ke-an'],'room_meal_lists'=>['label'=>'Danh sách phòng và mâm','folder_id'=>'','prefix'=>'Danh-sach']];}
...
function cds_drive_save_settings(array $settings): bool {if(function_exists('cds_instance_config')&&function_exists('cds_instance_save')){$instance=cds_instance_config();if(is_array($instance)&&$instance){$instance['drive']=$settings;$instance['updated_at']=date('c');return cds_instance_save($instance);}}return false!==file_put_contents(CDS_DRIVE_SETTINGS,json_encode($settings,JSON_UNESCAPED_UNICODE|JSON_PRETTY_PRINT),LOCK_EX);}
