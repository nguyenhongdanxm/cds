...
function cds_drive_default_types(): array {return ['documents'=>['label'=>'Văn bản','folder_id'=>'','prefix'=>'Van-ban'],'plans'=>['label'=>'Kế hoạch và báo cáo','folder_id'=>'','prefix'=>'Ke-hoach'],'education_plans'=>['label'=>'Kế hoạch giáo dục','folder_id'=>'','prefix'=>'Ke-hoach-giao-duc'],'learning_resources'=>['label'=>'Học liệu số','folder_id'=>'','prefix'=>'Hoc-lieu'],'exam_bank'=>['label'=>'Kiểm tra và thi','folder_id'=>'','prefix'=>'Kiem-tra-thi'],'photos'=>['label'=>'Ảnh học sinh','folder_id'=>'','prefix'=>'Anh-hoc-sinh'],'observations'=>['label'=>'Phiếu dự giờ','folder_id'=>'','prefix'=>'Phieu-du-gio'],'duty_reports'=>['label'=>'Biên bản trực nội trú','folder_id'=>'','prefix'=>'Bien-ban-truc'],'meal_reports'=>['label'=>'Thống kê ăn các lớp','folder_id'=>'','prefix'=>'Thong-ke-an'],'room_meal_lists'=>['label'=>'Danh sách phòng và mâm','folder_id'=>'','prefix'=>'Danh-sach']];}
