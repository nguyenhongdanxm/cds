...
<section class="stat-panel">
 ...
 <?php if ($canCsdlExport): ?><div class="px-3 pb-3"><a class="btn btn-outline-success btn-sm" href="<?=e(BASE_URL.'csdl_statistics_export_xlsx.php?'.http_build_query(['stat_scope'=>$population,'stat_status'=>$status,'stat_team'=>$team,'stat_grade'=>$grade,'stat_class'=>$classId]))?>"><i class="bi bi-file-earmark-excel"></i> Xuất hồ sơ theo phạm vi (.xlsx)</a><span class="text-muted small ms-2">Tệp Excel gồm các bảng hồ sơ và thống kê của đối tượng đã chọn.</span></div><?php endif; ?>
</section>
