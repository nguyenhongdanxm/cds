...
<script src="<?= e(BASE_URL . 'assets/noitru_att_report_layout.js?v=20260903-3') ?>" defer></script>
<script src="<?= e(BASE_URL . 'assets/noitru_att_reason_v2.js?v=20260903-3') ?>" defer></script>
<script src="<?= e(BASE_URL . 'assets/noitru_att_absence_groups.js?v=20260903-3') ?>" defer></script>
<?php endif; ?>
<?php if ($ntPage === 'noitru.php' && $ntTab === 'duty_report'): ?>
<script src="<?= e(BASE_URL . 'assets/noitru_duty_report_enhancements.js?v=20260903-3') ?>" defer></script>
<?php endif; ?>
