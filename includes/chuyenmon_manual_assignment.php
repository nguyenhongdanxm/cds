<?php
/** Phân công thủ công môn và số tiết trên trang Danh sách PCCM. */
...
if (($_SERVER['REQUEST_METHOD'] ?? 'GET') === 'POST' && isset($_POST['cds_manual_action'])) {
    ...
    header('Location: danhsach.php#cdsManualAssignments');
    exit;
}
