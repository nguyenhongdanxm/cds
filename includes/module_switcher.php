...
@keyframes cdsLauncherIn{from{opacity:0;transform:translateY(8px) scale(.985)}to{opacity:1;transform:none}}@media(max-width:760px){
 .cds-launcher{right:-31px;bottom:calc(76px + env(safe-area-inset-bottom));transition:right .16s ease}
 .cds-launcher:hover,.cds-launcher:focus-within,.cds-launcher.open{right:8px}
 .cds-launcher-button{width:48px;min-height:46px;padding:0;justify-content:center;border-radius:14px 0 0 14px}.cds-launcher-button span,.cds-launcher-button kbd{display:none}
