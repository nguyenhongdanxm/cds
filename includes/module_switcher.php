...
?>
<style>
.cds-launcher,.cds-launcher *{box-sizing:border-box}.cds-launcher{position:fixed;z-index:10050;right:-18px;bottom:38px;font-family:Inter,system-ui,-apple-system,"Segoe UI",sans-serif;transition:right .18s ease}.cds-launcher:hover,.cds-launcher:focus-within,.cds-launcher.open{right:12px}.cds-launcher-button{display:flex;align-items:center;justify-content:flex-start;gap:9px;width:54px;min-height:48px;padding:0 15px;border:1px solid #ffffffb8;border-radius:15px 0 0 15px;background:linear-gradient(135deg,#174f7e,#256ea6);color:#fff;box-shadow:0 10px 28px #0f274550;cursor:pointer;font-size:14px;font-weight:800;white-space:nowrap;overflow:hidden;transition:width .2s ease,transform .15s ease,box-shadow .15s ease,border-radius .2s ease}.cds-launcher:hover .cds-launcher-button,.cds-launcher:focus-within .cds-launcher-button,.cds-launcher.open .cds-launcher-button{width:224px;border-radius:15px}.cds-launcher-button:hover{transform:translateY(-1px);box-shadow:0 13px 32px #0f274560}.cds-launcher-button i{flex:0 0 22px;width:22px;font-size:18px;text-align:center}.cds-launcher-button span,.cds-launcher-button kbd{opacity:0;max-width:0;overflow:hidden;transition:opacity .14s ease,max-width .2s ease}.cds-launcher:hover .cds-launcher-button span,.cds-launcher:focus-within .cds-launcher-button span,.cds-launcher.open .cds-launcher-button span{opacity:1;max-width:110px}.cds-launcher:hover .cds-launcher-button kbd,.cds-launcher:focus-within .cds-launcher-button kbd,.cds-launcher.open .cds-launcher-button kbd{opacity:1;max-width:70px}.cds-launcher-button kbd{padding:2px 5px;border:1px solid #ffffff55;border-radius:5px;background:#ffffff18;color:#fff;font:600 10px/1.2 inherit}
.cds-launcher-backdrop{position:fixed;z-index:10049;inset:0;display:none;background:#0f172a80;backdrop-filter:blur(3px)}.cds-launcher.open .cds-launcher-backdrop{display:block}.cds-launcher-panel{position:fixed;z-index:10051;right:18px;bottom:98px;display:none;width:min(720px,calc(100vw - 36px));max-height:min(760px,calc(100vh - 120px));overflow:hidden;border:1px solid #dbe3ec;border-radius:20px;background:#f7f9fc;color:#172033;box-shadow:0 24px 80px #0f172a55}.cds-launcher.open .cds-launcher-panel{display:flex;flex-direction:column;animation:cdsLauncherIn .15s ease-out}
...
@keyframes cdsLauncherIn{from{opacity:0;transform:translateY(8px) scale(.985)}to{opacity:1;transform:none}}@media(max-width:760px){
 .cds-launcher{right:-22px;bottom:calc(92px + env(safe-area-inset-bottom));transition:right .16s ease}
 .cds-launcher:hover,.cds-launcher:focus-within,.cds-launcher.open{right:8px}
 .cds-launcher-button{width:50px;min-height:46px;padding:0 14px;justify-content:flex-start;border-radius:14px 0 0 14px}.cds-launcher:hover .cds-launcher-button,.cds-launcher:focus-within .cds-launcher-button,.cds-launcher.open .cds-launcher-button{width:50px;border-radius:14px}.cds-launcher-button span,.cds-launcher-button kbd,.cds-launcher:hover .cds-launcher-button span,.cds-launcher:focus-within .cds-launcher-button span,.cds-launcher.open .cds-launcher-button span,.cds-launcher:hover .cds-launcher-button kbd,.cds-launcher:focus-within .cds-launcher-button kbd,.cds-launcher.open .cds-launcher-button kbd{display:none;opacity:0;max-width:0}
 .cds-launcher-panel{inset:10px;width:auto;max-height:none;border-radius:18px}.cds-launcher-grid{grid-template-columns:1fr 1fr}.cds-launcher-body{padding:5px 12px 18px}.cds-launcher-search{padding:12px}.cds-launcher-search i{left:26px;top:26px}.cds-launcher-search span{right:24px;top:24px}.cds-launcher-head{padding:14px}
 .cm-mobile-bottom,.nt-bottom-nav,.mobile-nav,.td-mobile-nav,.ev-mobile,.mobile-dock{position:fixed!important;top:auto!important;right:0!important;bottom:0!important;left:0!important;margin:0!important;transform:none!important}
}@media(max-width:430px){.cds-launcher-grid{grid-template-columns:1fr}}
</style>
