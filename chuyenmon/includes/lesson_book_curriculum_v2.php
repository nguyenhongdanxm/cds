...
function lb_ppct_import_v2(array $file): array {
 ...
 if($errors)return['ok'=>false,'message'=>'Không nhập dữ liệu vì phát hiện '.count($errors).' lỗi. '.implode(' ',array_slice($errors,0,8)).(count($errors)>8?' …':'')];
