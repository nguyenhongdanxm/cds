...
function cds_current_page_feature() {
    ...
    $map = [
        ...
        'kehoach'=>'cm.kehoach', 'boiduong'=>'cm.kehoach', 'activities'=>'cm.kehoach', 'sodaubai'=>'cm.dashboard', 'sodaubai_export'=>'cm.dashboard', 'sodaubai_ppct_template'=>'cm.dashboard', 'sodaubai_ppct_import_v2'=>'cm.dashboard',
...
function require_login() {
    ...
    if (($_SERVER['REQUEST_METHOD'] ?? 'GET') === 'POST') {
        ...
        if (!$supportSelfService && !$homeSelfService && !cds_can_feature(cds_current_page_feature(), $requiredLevel)) {
            http_response_code(403);
