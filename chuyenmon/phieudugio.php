...
?>
<style>
.lesson-sheet{max-width:920px;margin:auto;background:#fff;padding:22px 30px;border-radius:12px;box-shadow:0 3px 16px rgba(15,23,42,.09);font-size:14px}.sheet-school{font-family:"Times New Roman",serif;font-size:14px;line-height:1.25}.sheet-title{text-align:center;font:bold 22px "Times New Roman",serif;margin:14px 0 8px}.sheet-meta{display:grid;grid-template-columns:1fr;gap:2px;margin-bottom:9px;font-family:"Times New Roman",serif;font-size:14px;line-height:1.2}.sheet-meta>div{border-bottom:1px dotted #555;padding:2px 0}.meta-triplet{display:grid!important;grid-template-columns:repeat(3,minmax(0,1fr));gap:20px}.score-table{width:100%;border-collapse:collapse;font-family:"Times New Roman",serif;font-size:13px;line-height:1.22}.score-table th,.score-table td{border:1px solid #333;padding:4px 6px;vertical-align:middle}.score-table th{text-align:center}.score-table .group{width:112px;font-weight:bold;text-align:center}.score-table .criterion{text-align:left}.score-table .max,.score-table .score{width:78px;text-align:center}.score-table input{width:62px;text-align:center;padding:3px;border:1px solid #aab4c3;border-radius:4px;font-size:13px}.sheet-signatures{display:grid;grid-template-columns:1fr 1fr;text-align:center;margin-top:7px;font-family:"Times New Roman",serif;font-size:14px;line-height:1.2}.signature-date{min-height:18px;font-style:italic}.signature-space{height:34px}.signature-name{font-weight:bold}.sheet-actions{display:flex;flex-wrap:wrap;gap:8px;margin:0 auto 12px;max-width:920px}.sheet-observer-tabs{display:flex;flex-wrap:wrap;gap:6px;margin-bottom:8px}.sheet-result{text-align:center;margin-top:5px;font:700 14px "Times New Roman",serif}.sheet-save{text-align:center;margin-top:7px}.pdf-mode{width:190mm!important;max-width:190mm!important;padding:0!important;border-radius:0!important;box-shadow:none!important}.pdf-mode .no-print{display:none!important}.pdf-mode .score-table input{border:0;padding:0;font:inherit}
...
@media print{@page{size:A4 portrait;margin:8mm}html,body{width:210mm!important;height:297mm!important;background:#fff!important}.navbar,.sidebar,.topbar,.app-header,.sheet-actions,footer,.no-print{display:none!important}body>.container,.container,.main-content,.content-wrapper,main{margin:0!important;padding:0!important;width:100%!important;max-width:none!important}.lesson-sheet{width:194mm!important;max-width:194mm!important;box-sizing:border-box;box-shadow:none;border-radius:0;padding:0;margin:0 auto;font-size:10pt}.sheet-school{font-size:10pt}.sheet-title{font-size:16pt;margin:7px 0 5px}.sheet-meta{font-size:10pt;gap:1px;margin-bottom:5px}.sheet-meta>div{padding:1px 0}.score-table{font-size:9.5pt;line-height:1.15}.score-table th,.score-table td{padding:2px 4px}.score-table input{border:0;padding:0;font:inherit}.sheet-result{font-size:10pt;margin-top:3px}.sheet-signatures{font-size:10pt;margin-top:4px}.signature-space{height:27px}.signature-date{min-height:17px}}
</style>
...
document.getElementById('downloadPdf')?.addEventListener('click',async function(){
  ...
  try{
    ...
    const pageWidth=210,pageHeight=297,margin=8,maxWidth=pageWidth-margin*2,maxHeight=pageHeight-margin*2;
