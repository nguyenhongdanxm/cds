...
$tmp=tempnam(sys_get_temp_dir(),'lb_ppct_');if($tmp===false||!lb_ppct_template_xlsx($tmp)){http_response_code(500);exit('Không tạo được mẫu Excel. Hosting cần bật ZipArchive.');}
