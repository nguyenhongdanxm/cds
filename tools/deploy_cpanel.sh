...
cd "$SOURCE_ROOT"
/usr/bin/timeout 45 /bin/cp activity.php admin.php hoclieu.php hoclieu_file.php hoclieu_game.php hoclieu_game_qr_trial.php hoclieu_game_quiz.php hoclieu_game_quiz_join.php hoclieu_game_quiz_screen.php hoclieu_quiz_cards.php hoclieu_game_olympia.php hoclieu_game_olympia_play.php hoclieu_game_olympia_screen.php hoclieu_game_olympia_live.php hoclieu_game_olympia_rankings.php olympia_stage.php olympia_stage_api.php olympia_san_khau_preview.html chuyenmon.php csdl.php csdl_preweeks.php csdl_export.php csdl_student_cards.php danhgia.php dashboard_settings.php database_admin.php index.php login.php logout.php manifest.webmanifest noitru.php noitru_attendance.php noitru_list.php noitru_assign.php noitru_assign_enhanced.php noitru_assign_sync.php noitru_room_template.php noitru_room_roles.php noitru_room_roles_data.php noitru_room_quick_save.php push_api.php student_card_students.php student_photo.php student_verify.php sw.js thoikhoabieu.php thuvien.php thuvien_book_supplement.php thuvien_bienban.php thietbi_phieu.php thidua.php thidua_baiviet.php thidua_phongnoitru.php tienich_chunhiem.php users.php vanban.php "$DEPLOY_ROOT"
