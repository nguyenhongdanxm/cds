...
header('Content-Type: '.$file['mime']);header('Content-Length: '.strlen($file['body']));header("Content-Disposition: inline; filename*=UTF-8''".rawurlencode($file['name']));header('Cache-Control: private, max-age=3600');echo $file['body'];
