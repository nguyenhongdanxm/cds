...
<div class="row g-3">
<div class="col-md-6 col-xl-4"><div class="card resource-card p-4 h-100" style="background:linear-gradient(145deg,#e8f8ff,#fff)"><div class="d-flex gap-3 mb-3"><span class="resource-icon" style="background:#dbf1ff;color:#126bb0"><i class="bi bi-qr-code-scan"></i></span><div><h5 class="fw-bold mb-1">Trả lời bằng thẻ QR · Thử nghiệm</h5><div class="small text-muted">Chọn lớp, in thẻ A–D, quét đáp án bằng điện thoại và xem kết quả</div></div></div><a class="btn btn-primary" href="<?= BASE_URL ?>hoclieu_game_qr_trial.php"><i class="bi bi-play-circle me-1"></i> Mở trò chơi thử</a></div></div>
