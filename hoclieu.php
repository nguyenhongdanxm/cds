...
<div class="col-md-6 col-xl-4"><div class="card resource-card p-4 h-100"><div class="d-flex gap-3 mb-3"><span class="resource-icon"><i class="bi bi-emoji-smile"></i></span><div><h5 class="fw-bold mb-1">Đua vịt gắn tên học sinh</h5><div class="small text-muted">Trò chơi Canva AI chạy ngay trong Học liệu</div></div></div><a class="btn btn-primary" href="<?= BASE_URL ?>hoclieu_game_duavit.php"><i class="bi bi-play-circle me-1"></i> Mở trò chơi</a></div></div>
