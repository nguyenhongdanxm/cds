...
<div class="col-md-6 col-xl-4"><div class="card resource-card p-4 h-100"><div class="d-flex gap-3 mb-3"><span class="resource-icon"><i class="bi bi-dice-5"></i></span><div><h5 class="fw-bold mb-1">Máy lô tô gọi tên</h5><div class="small text-muted">Quay số ngẫu nhiên theo danh sách học sinh của lớp</div></div></div><a class="btn btn-primary" href="<?= BASE_URL ?>hoclieu_game_loto.php"><i class="bi bi-play-circle me-1"></i> Mở trò chơi</a></div></div>
