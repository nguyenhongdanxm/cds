...
$tab = in_array($_GET['tab'] ?? '', ['dashboard', 'resources', 'exams', 'games', 'links'], true) ? (string)$_GET['tab'] : 'dashboard';
...
<?php if($canResourceView):?><li><a class="nav-link <?= $tab==='games'?'active':'' ?>" href="?tab=games"><i class="bi bi-trophy me-1"></i>Trò chơi</a></li><?php endif;?>
...
<?php elseif ($tab === 'games' && $canResourceView): ?>
<div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-3"><div><h2 class="fw-bold mb-1">Trò chơi hỗ trợ dạy học</h2><p class="text-muted mb-0">Giáo viên chỉnh phần thưởng, học sinh quay ngay trên lớp hoặc máy chiếu.</p></div></div>
<div class="row g-3">
<div class="col-md-6 col-xl-4"><div class="card resource-card p-4 h-100" style="background:linear-gradient(145deg,#e8f8ff,#fff)"><div class="d-flex gap-3 mb-3"><span class="resource-icon" style="background:#dbf1ff;color:#126bb0"><i class="bi bi-qr-code-scan"></i></span><div><h5 class="fw-bold mb-1">Bộ câu hỏi A–D · Máy tính và thẻ giấy</h5><div class="small text-muted">Tự tạo bộ câu hỏi; học sinh chơi trên máy tính hoặc giơ thẻ A–D để giáo viên quét</div></div></div><a class="btn btn-primary" href="<?= BASE_URL ?>hoclieu_game_quiz.php"><i class="bi bi-play-circle me-1"></i> Tạo câu hỏi và mở trò chơi</a></div></div>
<div class="col-md-6 col-xl-4"><div class="card resource-card p-4 h-100"><div class="d-flex gap-3 mb-3"><span class="resource-icon"><i class="bi bi-person-vcard"></i></span><div><h5 class="fw-bold mb-1">Thẻ trả lời A–D</h5><div class="small text-muted">Xem danh sách học sinh theo lớp, in thẻ QR dùng lại cho mọi bộ câu hỏi</div></div></div><a class="btn btn-outline-primary" href="<?= BASE_URL ?>hoclieu_quiz_cards.php"><i class="bi bi-printer me-1"></i> Quản lý và in thẻ</a></div></div>
<div class="col-md-6 col-xl-4"><div class="card resource-card p-4 h-100" style="background:linear-gradient(145deg,#fff7d6,#fff)"><div class="d-flex gap-3 mb-3"><span class="resource-icon" style="background:#fff0a8;color:#9a5b00"><i class="bi bi-mortarboard-fill"></i></span><div><h5 class="fw-bold mb-1">Đường lên đỉnh Olympia</h5><div class="small text-muted">Thi kiến thức theo tuần, ghi nhận học sinh trả lời đúng và xếp hạng toàn trường</div></div></div><a class="btn btn-warning fw-bold" href="<?= BASE_URL ?>hoclieu_game_olympia.php"><i class="bi bi-play-circle me-1"></i> Mở Olympia</a></div></div>
<div class="col-md-6 col-xl-4"><div class="card resource-card p-4 h-100"><div class="d-flex gap-3 mb-3"><span class="resource-icon"><i class="bi bi-trophy"></i></span><div><h5 class="fw-bold mb-1">Vòng quay may mắn</h5><div class="small text-muted">Quay phần thưởng, câu hỏi hoặc nhiệm vụ trên lớp</div></div></div><a class="btn btn-primary" href="<?= BASE_URL ?>hoclieu_game.php"><i class="bi bi-play-circle me-1"></i> Mở trò chơi</a></div></div>
<div class="col-md-6 col-xl-4"><div class="card resource-card p-4 h-100"><div class="d-flex gap-3 mb-3"><span class="resource-icon"><i class="bi bi-people"></i></span><div><h5 class="fw-bold mb-1">Kéo co kiến thức</h5><div class="small text-muted">Hai đội trả lời trắc nghiệm, kéo dây về phía mình</div></div></div><a class="btn btn-primary" href="<?= BASE_URL ?>hoclieu_game_keoco.php"><i class="bi bi-play-circle me-1"></i> Mở trò chơi</a></div></div>
<div class="col-md-6 col-xl-4"><div class="card resource-card p-4 h-100"><div class="d-flex gap-3 mb-3"><span class="resource-icon"><i class="bi bi-emoji-smile"></i></span><div><h5 class="fw-bold mb-1">Đua vịt gắn tên học sinh</h5><div class="small text-muted">Đường đua vịt native: chọn lớp, xáo làn và tìm người về đích</div></div></div><a class="btn btn-primary" href="<?= BASE_URL ?>hoclieu_game_duavit.php"><i class="bi bi-play-circle me-1"></i> Mở trò chơi</a></div></div>
<div class="col-md-6 col-xl-4"><div class="card resource-card p-4 h-100"><div class="d-flex gap-3 mb-3"><span class="resource-icon"><i class="bi bi-dice-5"></i></span><div><h5 class="fw-bold mb-1">Quay số gọi tên</h5><div class="small text-muted">Quay số ngẫu nhiên theo danh sách học sinh của lớp</div></div></div><a class="btn btn-primary" href="<?= BASE_URL ?>hoclieu_game_loto.php"><i class="bi bi-play-circle me-1"></i> Mở trò chơi</a></div></div>
<div class="col-md-6 col-xl-4"><div class="card resource-card p-4 h-100"><div class="d-flex gap-3 mb-3"><span class="resource-icon"><i class="bi bi-music-note-beamed"></i></span><div><h5 class="fw-bold mb-1">Chớp Nốt</h5><div class="small text-muted">Âm nhạc: hình gợi nhớ, khuông, trường độ, nhạc cụ</div></div></div><a class="btn btn-primary" href="<?= BASE_URL ?>hoclieu_game_chopnot.php"><i class="bi bi-play-circle me-1"></i> Mở trò chơi</a></div></div>
</div>
<?php else: ?>
