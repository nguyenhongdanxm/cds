...
.engagement-tabs{display:flex;gap:.4rem;padding:.35rem;background:#eae7f7;border-radius:13px;margin-bottom:1rem;width:max-content;max-width:100%;overflow:auto}.engagement-tabs a,.engagement-tabs span{display:flex;align-items:center;gap:.4rem;padding:.65rem .9rem;border-radius:10px;text-decoration:none;color:var(--vb-dark);font-weight:800;white-space:nowrap}.engagement-tabs a.active{background:#fff;box-shadow:0 3px 12px #30206f18}.engagement-tabs .locked-tab{opacity:.45}.stats-list{overflow:hidden}.stats-head{display:flex;justify-content:space-between;padding:1rem;border-bottom:1px solid var(--line)}.stats-round{width:100%;display:grid;grid-template-columns:1fr auto auto;align-items:center;text-align:left;gap:1rem;padding:1rem;border:0;border-bottom:1px solid var(--line);background:#fff;cursor:pointer;color:var(--ink)}.stats-round:hover{background:#faf9fe}.stats-round strong,.stats-round small{display:block}.stats-round small{margin-top:.25rem;color:var(--muted)}.stat-result{margin-bottom:.85rem}.participants-title{font-size:1rem;margin:1.25rem 0 .55rem}.participants{display:grid;grid-template-columns:1fr 1fr;gap:.5rem}.participants>div{display:flex;gap:.55rem;padding:.65rem;background:#f7f5fd;border-radius:10px}.participants small{display:block;color:var(--muted);margin-top:.15rem}.stats-modal{max-width:760px}
@media(max-width:900px){.engage-grid{grid-template-columns:1fr}.reply-form{grid-template-columns:1fr}.participants{grid-template-columns:1fr}.mobile-nav{display:flex!important;overflow-x:auto;justify-content:flex-start}.mobile-nav a{flex:0 0 78px}.mobile-nav a.locked{opacity:.38;pointer-events:none}}
