...
.document-table{width:100%;min-width:760px;table-layout:fixed}.document-table th:nth-child(1){width:19%}.document-table th:nth-child(2){width:38%}.document-table th:nth-child(3){width:12%}.document-table th:nth-child(4){width:14%}.document-table th:nth-child(5){width:17%}.document-table.manage-table th:nth-child(1){width:16%}.document-table.manage-table th:nth-child(2){width:31%}.document-table.manage-table th:nth-child(3){width:10%}.document-table.manage-table th:nth-child(4){width:12%}.document-table.manage-table th:nth-child(5){width:15%}.document-table.manage-table .action-column{width:16%}.document-title-cell{min-width:0}.document-title-cell .doc-title-link,.document-title-cell .sub{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.document-table td:last-child{white-space:normal}
