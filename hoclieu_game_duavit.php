...
.river{position:absolute;inset:0;z-index:2;overflow:hidden}.start-line{position:absolute;z-index:1;top:27px;bottom:27px;left:9%;width:5px;background:repeating-linear-gradient(180deg,#fff 0 11px,#183f59 11px 22px);border-radius:3px;box-shadow:0 0 0 2px #ffffff99,0 0 12px #06334d66}.start-line:after{content:"XUẤT PHÁT";position:absolute;top:50%;left:-34px;transform:rotate(-90deg);transform-origin:center;background:#fff;color:#0b4963;border:2px solid #0b4963;border-radius:9px;padding:3px 8px;font-size:9px;font-weight:950;letter-spacing:.08em;white-space:nowrap}.duck{position:absolute;width:68px;height:50px;transform:translate(-50%,-50%);filter:drop-shadow(0 5px 2px #075a7370);will-change:left,top,transform;z-index:2;animation:duckBob 1.1s ease-in-out infinite alternate}.duck:after{content:"";position:absolute;left:-20px;top:36px;width:48px;height:9px;border-top:3px solid #dffbffb8;border-radius:50%;animation:wake 1s ease-in-out infinite}.duck .body{position:absolute;inset:12px 5px 0;border-radius:56% 45% 50% 48%;background:radial-gradient(circle at 34% 22%,#fff9 0 7%,transparent 8%),linear-gradient(145deg,var(--duck-light,#fff080),var(--duck-body,#ffc52d) 64%,var(--duck-dark,#e99b00));border:2px solid var(--duck-edge,#d88e00)}.duck .head{position:absolute;right:3px;top:1px;width:29px;height:29px;border-radius:50%;background:var(--duck-head,#ffdf4e);border:2px solid var(--duck-edge,#d88e00)}.duck .head:before{content:"";position:absolute;right:4px;top:8px;width:6px;height:6px;background:#102d40;border-radius:50%;box-shadow:0 0 0 2px #fff}.duck .beak{position:absolute;right:-8px;top:16px;width:16px;height:10px;border-radius:2px 9px 9px 2px;background:#ff7845;border:1px solid #c94f2c}.duck .wing{position:absolute;left:14px;top:24px;width:27px;height:19px;border-radius:50%;background:var(--duck-dark,#f2ab12);border:1px solid var(--duck-edge,#d88e00);transform-origin:80% 50%;animation:wingIdle 1.2s ease-in-out infinite alternate}.duck .cap{position:absolute;right:7px;top:-4px;width:19px;height:8px;border-radius:10px 10px 2px 2px;background:#ef5f5b}.duck .name{position:absolute;z-index:5;left:50%;bottom:48px;transform:translateX(-50%);max-width:170px;min-width:92px;padding:3px 8px;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;text-align:center;color:#082f47;background:#fff;border:2px solid var(--duck-edge,#d88e00);border-radius:9px;font-size:11px;font-weight:950;line-height:15px;box-shadow:0 3px 7px #06334d55}.duck .name:after{content:"";position:absolute;left:50%;bottom:-6px;width:8px;height:8px;background:#fff;border-right:2px solid var(--duck-edge,#d88e00);border-bottom:2px solid var(--duck-edge,#d88e00);transform:translateX(-50%) rotate(45deg)}.river.racing .duck{animation-duration:.42s}.river.racing .duck .wing{animation:wingRace .22s ease-in-out infinite alternate}.duck.winner{z-index:6;filter:drop-shadow(0 0 11px #fff500) drop-shadow(0 5px 2px #075a7370)}@keyframes duckBob{to{margin-top:-3px}}@keyframes wingIdle{to{transform:rotate(7deg)}}@keyframes wingRace{from{transform:rotate(-28deg)}to{transform:rotate(18deg) scaleY(.8)}}@keyframes wake{50%{width:61px;opacity:.45}}.ripple{position:absolute;width:20px;height:8px;border:2px solid #e3fcff99;border-radius:50%;transform:translate(-50%,-50%);pointer-events:none;animation:ripple .8s ease-out forwards}@keyframes ripple{to{width:75px;height:29px;opacity:0}}.splash{position:absolute;color:#e9feff;font-size:21px;font-weight:900;pointer-events:none;animation:splash .65s ease-out forwards}@keyframes splash{to{transform:translate(var(--sx),-28px) rotate(25deg);opacity:0}}
...
function positionDucks(){
 ...
 pond.style.height=Math.max(470,Math.min(930,total*25+85))+'px';
 ducks.forEach((duck,i)=>{duck.dataset.x='9';duck.dataset.y=(6+((i+.5)/Math.max(1,total))*88).toFixed(2);duck.dataset.seed=(Math.random()*100).toFixed(2);duck.style.left='9%';duck.style.top=duck.dataset.y+'%';duck.style.zIndex=String(2+i%2)});
}
...
function begin(){
 if(racing||racers.length<2)return;racing=true;river.classList.add('racing');start.disabled=true;$('status').textContent='Xuất phát! Cổ vũ thật lớn nào!';
